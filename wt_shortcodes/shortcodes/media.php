...
if (!function_exists('wellthemes_video_shortcode')) {
	...
	function wellthemes_video_shortcode( $atts, $content = null ) {
		...
		if($type == 'youtube'){
			return '<iframe class="wellthemes-video '.esc_attr($align).'" width="'.$width.'" height="'.$height.'" src="http://www.youtube.com/embed/'.$id.'?wmode=transparent" frameborder="0" allowfullscreen></iframe>';
		} else	{
