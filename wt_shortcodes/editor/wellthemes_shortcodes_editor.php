...
class wellthemesShortcodes {
	...
	function action_admin_scripts_init() {
		wp_localize_script( 'jquery', 'wellthemesShortCodes', array('plugin_folder' => plugin_dir_url( __FILE__ )) );
	}
	...
	function add_rich_plugins( $plugin_array ) {	
		$plugin_array['wellthemesShortcodes'] = plugin_dir_url( __FILE__ ) . '/js/wellthemes_shortcodes_tinymce.js';		
		return $plugin_array;
	}
